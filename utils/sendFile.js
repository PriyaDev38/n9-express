...
let storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    // you must take public folder manually or it will throw error like no such file or directory.
...
let fileFilter = (req, file, cb) => {
  ...
  if (isValidExtension) {
    ...
    // null repsresent error since there is no error thus error is null
  } else {
